...
class Mixed_patient_level_dataset(Dataset):
    ...
    def __init__(
        ...
        random_cell_stratification=0.0,
    ):
        super(Mixed_patient_level_dataset, self).__init__()
    ...
    def stratified_cell_selection(self, h5ad_file: sc.AnnData) -> list:
        ...
        elif "treatment" in h5ad_file.obs.columns:
            cell_identifier = "treatment"
        else:
            print("no cell type found for stratified cell selection")
